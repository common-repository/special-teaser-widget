...
class STW_DynamicCSS extends A5_DynamicFiles {
	...
	function __construct() {
		...
		parent::__construct('wp', 'css', 'all', false, self::$options['inline'], self::$options['compress']);
		
		parent::__construct('admin', 'css', 'all', 'plugins_page_special-teaser-settings', true); 
